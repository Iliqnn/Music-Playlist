...
public class ShowPlaylistCommand implements Command {
    ...
    public String execute(String[] args) {
        ...
        if (p == null) {
            return "Error: music_model.Playlist not found.";
        }

        StringBuilder sb = new StringBuilder();
        sb.append("music_model.Playlist: ").append(p.getName()).append("\n");
        ...
        if (songs.isEmpty()) {
            ...
            sb.append("\nTotal music_model.Playlist Duration: ").append(manager.formatSecondsToDuration(totalSeconds));
        }
